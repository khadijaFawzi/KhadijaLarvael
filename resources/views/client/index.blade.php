...
<html lang="ar" dir="rtl">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('/client/assets/css/odometer.min.css')}}">
        <link rel="stylesheet" href="{{asset('/client/assets/css/nice-select.min.css')}}">
        ...
        <link rel="stylesheet" href="{{asset('/client/assets/css/fancybox.min.css')}}">
		...
		<link rel="stylesheet" href="{{asset('/client/assets/css/rtl.css')}}">
		
		<title>Fido - Real Estate & Housing HTML Template</title>

        <link rel="icon" type="image/png" href="{{asset('/client/assets/images/favicon.png')}}">
    </head>
    ...
    <body>
            ...
            <div class="main-responsive-nav">
                <div class="container">
                    <div class="main-responsive-menu">
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{asset('/client/assets/images/black-logo.png')}}" class="black-logo" alt="image">
                                <img src="{{asset('/client/assets/images/white-logo.png')}}" class="white-logo" alt="image">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="main-slides-area">
            ...
            <div class="main-slides-content">
                <div class="container">
                    <div class="content">
                        <h1 class="wow animate__animated animate__fadeInUp" data-wow-delay="100ms" data-wow-duration="1000ms">Luxury, Smart and Modern Style With 5 Star Rating</h1>
                    </div>
    
                    <div class="tab slides-list-tab wow animate__animated animate__fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                        <ul class="tabs">
                            <li>RENT</li>
                            <li>SELL</li>
                        </ul>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="form-group">
                                                    <div class="price-range-content">
                                                        <div class="price-range-filter d-flex align-items-center">
                                                            <p><i class='bx bx-money'></i>Price:</p>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="form-group">
                                                    <div class="price-range-content">
                                                        ...
                                                        <div class="price-range-bar" id="range-slider-2"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="fun-facts-area">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-2 col-sm-6 col-md-6">
                            <div class="single-category">
                                <a href="property.html"><img src="{{asset('/client/assets/images/category/category-1.png')}}" alt="image"></a>
                                <h3>
                        ...
                        <div class="col-lg-2 col-sm-6 col-md-6">
                            <div class="single-category">
                                <a href="property.html"><img src="{{asset('/client/assets/images/category/category-2.png')}}" alt="image"></a>
                                <h3>
                        ...
                        <div class="col-lg-2 col-sm-6 col-md-6">
                            <div class="single-category">
                                <a href="property.html"><img src="{{asset('/client/assets/images/category/category-3.png')}}" alt="image"></a>
                                <h3>
                        ...
                        <div class="col-lg-2 col-sm-6 col-md-6">
                            <div class="single-category">
                                <a href="property.html"><img src="{{asset('/client/assets/images/category/category-4.png')}}" alt="image"></a>
                                <h3>
                        ...
                        <div class="col-lg-2 col-sm-6 col-md-6">
                            <div class="single-category">
                                <a href="property.html"><img src="{{asset('/client/assets/images/category/category-5.png')}}" alt="image"></a>
                                <h3>
                        ...
                        <div class="col-lg-2 col-sm-6 col-md-6">
                            <div class="single-category">
                                <a href="property.html"><img src="{{asset('/client/assets/images/category/category-6.png')}}" alt="image"></a>
                                <h3>
            ...
            <div class="container pb-100">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-fun-fact">
                            <h3>
                                <span class="odometer" data-count="10245">00</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-fun-fact">
                            <h3>
                                <span class="odometer" data-count="24245">00</span>
                                <span class="sign-icon">+</span>
                            </h3>
                            <p>Apartment Rent</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-fun-fact">
                            <h3>
                                <span class="odometer" data-count="13248">00</span>
                                <span class="sign-icon">+</span>
                            </h3>
                            <p>Property Sales</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-fun-fact">
                            <h3>
                                <span class="odometer" data-count="90245">00</span>
                                <span class="sign-icon">+</span>
                            </h3>
                            <p>Happy Clients</p>
                        </div>
                ...
                <div class="fun-text">
                    <p>Proin gravida nib vel velit auctor aliquet aenean sollicitudin lorem <a href="about.html">About Us</a></p>
                </div>
            </div>
        </div>
        <!-- End Fun Facts Area -->
        ...
        <div class="featured-area-two ptb-100">
            <div class="container">
                ...
                <div class="featured-slides owl-carousel owl-theme">
                    <div class="featured-item with-white-color">
                        <div class="featured-image">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/featured/featured-1.jpg')}}" alt="image"></a>
                    ...
                    <div class="featured-item with-white-color">
                        <div class="featured-image">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/featured/featured-2.jpg')}}" alt="image"></a>
                    ...
                    <div class="featured-item with-white-color">
                        <div class="featured-image">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/featured/featured-3.jpg')}}" alt="image"></a>
                ...
                <div class="view-featured-btn">
                    <a href="property.html" class="default-btn">VIEW ALL APARTMENT<span></span></a>
                </div>
            </div>
        </div>
        <!-- End Featured Area -->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-facilities">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/facilities/facilities-1.png')}}" alt="image">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-facilities">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/facilities/facilities-2.png')}}" alt="image">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-facilities">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/facilities/facilities-3.png')}}" alt="image">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-facilities">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/facilities/facilities-4.png')}}" alt="image">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-facilities">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/facilities/facilities-5.png')}}" alt="image">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-facilities">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/facilities/facilities-6.png')}}" alt="image">
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-neighborhood-box">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/neighborhood/neighborhood-1.jpg')}}" alt="image"></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-neighborhood-box">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/neighborhood/neighborhood-2.jpg')}}" alt="image"></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-neighborhood-box">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/neighborhood/neighborhood-3.jpg')}}" alt="image"></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-neighborhood-box">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/neighborhood/neighborhood-4.jpg')}}" alt="image"></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-neighborhood-box">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/neighborhood/neighborhood-5.jpg')}}" alt="image"></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-neighborhood-box">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/neighborhood/neighborhood-6.jpg')}}" alt="image"></a>
                ...
                <div class="agents-slides owl-carousel owl-theme">
                    <div class="agents-item">
                        <div class="agents-image">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/agents/agents-1.jpg')}}" alt="image"></a>
                    ...
                    <div class="agents-item">
                        <div class="agents-image">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/agents/agents-2.jpg')}}" alt="image"></a>
                    ...
                    <div class="agents-item">
                        <div class="agents-image">
                            <a href="property-details.html"><img src="{{asset('/client/assets/images/agents/agents-3.jpg')}}" alt="image"></a>
                ...
                <div class="customers-slides owl-carousel owl-theme">
                    <div class="customers-item">
                        <div class="customers-info">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/customers/image-1.jpg')}}" alt="image">
                            </div>
                    ...
                    <div class="customers-item">
                        <div class="customers-info">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/customers/image-2.jpg')}}" alt="image">
                            </div>
                    ...
                    <div class="customers-item">
                        <div class="customers-info">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/customers/image-3.jpg')}}" alt="image">
                            </div>
                    ...
                    <div class="customers-item">
                        <div class="customers-info">
                            <div class="image">
                                <img src="{{asset('/client/assets/images/customers/image-4.jpg')}}" alt="image">
                            </div>
        ...
        <div class="blog-area ptb-100">
            <div class="container">
                ...
                <div class="blog-slides owl-carousel owl-theme">
                    <div class="blog-item">
                        <a href="blog-details.html"><img src="{{asset('/client/assets/images/blog/blog-1.jpg')}}" alt="image"></a>

                        <div class="blog-content">
                            <span><a href="blog-details.html">APARTMENT</a></span>
                            <h3>
                                <a href="blog-details.html">Redfin Unveils the Best Canadian  Cities for Biking</a>
                            </h3>
                        </div>

                        <div class="blog-bottom-content d-flex justify-content-between align-items-center">
                            <div class="blog-author d-flex align-items-center">
                                <img src="{{asset('/client/assets/images/blog/image-1.jpg')}}" class="rounded-circle" alt="image">
                                <span><a href="blog-details.html">Alex Morgan</a></span>
                            </div>

                            <p><i class='bx bx-calendar'></i>February 24, 2024</p>
                        </div>
                    </div>

                    <div class="blog-item">
                        <a href="blog-details.html"><img src="{{asset('/client/assets/images/blog/blog-2.jpg')}}" alt="image"></a>

                        <div class="blog-content">
                            <span><a href="blog-details.html">HOUSES</a></span>
                            <h3>
                                <a href="blog-details.html">Apartio Helps Get Your Dream & Luxury Space Alexa</a>
                            </h3>
                        </div>

                        <div class="blog-bottom-content d-flex justify-content-between align-items-center">
                            <div class="blog-author d-flex align-items-center">
                                <img src="{{asset('/client/assets/images/blog/image-2.jpg')}}" class="rounded-circle" alt="image">
                                <span><a href="blog-details.html">Nia Matos</a></span>
                            </div>

                            <p><i class='bx bx-calendar'></i>February 25, 2024</p>
                        </div>
                    </div>

                    <div class="blog-item">
                        <a href="blog-details.html"><img src="{{asset('/client/assets/images/blog/blog-3.jpg')}}" alt="image"></a>

                        <div class="blog-content">
                            <span><a href="blog-details.html">COMMERCIAL</a></span>
                            <h3>
                                <a href="blog-details.html">Housing Markets That Changed the  Most This Decade</a>
                            </h3>
                        </div>

                        <div class="blog-bottom-content d-flex justify-content-between align-items-center">
                            <div class="blog-author d-flex align-items-center">
                                <img src="{{asset('/client/assets/images/blog/image-3.jpg')}}" class="rounded-circle" alt="image">
                                <span><a href="blog-details.html">Milana Myles</a></span>
                            </div>

                            <p><i class='bx bx-calendar'></i>February 26, 2024</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-widget">
                            <div class="widget-logo">
                                <a href="index.html">
                                    <img src="{{asset('/client/assets/images/white-logo.png')}}" alt="image">
                                </a>
                            </div>

                            <p>Aenean sollicitudin lorem quis bibendum auctor nisi elit consequat ipsum necdo sagittis sem nibh id elit consequat ipsum.</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-quick-links">
                                ...
                                <li><a href="agents.html">MEET OUR AGENTS</a></li>
                                <li><a href="services.html">OUR SERVICES</a></li>
                                <li><a href="property.html">PROPERTIES</a></li>
                                <li><a href="case-study.html">APARTMENTS</a></li>
                                <li><a href="case-study.html">HOUSE</a></li>
                                <li><a href="case-study.html">VILLA</a></li>
                                <li><a href="case-study.html">OFFICE</a></li>
                                <li><a href="listing.html">SELL OR RENT</a></li>
                                <li><a href="listing.html">New PROPERTIES</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="widget-info">
                                ...
                                <li>
                                    <i class='bx bx-envelope'></i>
                                    <a href="mailto:hello@fido.com">hello@fido.com</a>
                                </li>
            ...
            <div class="copyright-area">
                <div class="container">
                    <div class="copyright-area-content">
                        <p>© Fido is Proudly Owned by <a href="https://envytheme.com/" target="_blank">EnvyTheme</a></p>
                    </div>
                </div>
            </div>
        </footer>
        ...
        <script src="{{asset('/client/assets/js/jquery.meanmenu.js')}}"></script>
        <script src="{{asset('/client/assets/js/owl.carousel.min.js')}}"></script>
        <script src="{{asset('/client/assets/js/jquery.appear.js')}}"></script>
